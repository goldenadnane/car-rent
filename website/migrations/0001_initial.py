# Generated by Django 3.0.5 on 2023-05-04 13:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='website.Customer')),
                ('model', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='website.Car')),
            ],
        ),
        migrations.AddField(
            model_name='car',
